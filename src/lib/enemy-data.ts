...
import { applyRoleModifiers, getCritForRarity } from './battle-engine'
...
const campaignEnemies: EnemyTemplate[] = [
  // Chapter 1 — low tier (common)
  {
    id: 'enemy_shade_grunt', name: 'Shade Grunt', faction: 'Veil Walkers', role: 'offensive', rarity: 'common',
    modelId: 'model_enemy_shade_grunt', portraitId: 'portrait_enemy_shade_grunt',
    baseHp: 3000, baseAtk: 800, baseDef: 400, baseSpd: 100, baseAcc: 85, baseRes: 85,
    skills: [{ name: 'Dark Swipe', cooldown: 3, level: 1, type: 'damage', multiplier: 1.3, targetType: 'enemy', description: 'Basic shadow attack' }],
  },
  {
    id: 'enemy_ember_imp', name: 'Ember Imp', faction: 'Stormborn', role: 'offensive', rarity: 'common',
    modelId: 'model_enemy_ember_imp', portraitId: 'portrait_enemy_ember_imp',
    baseHp: 2500, baseAtk: 900, baseDef: 350, baseSpd: 120, baseAcc: 85, baseRes: 85,
    skills: [{ name: 'Flame Spit', cooldown: 2, level: 1, type: 'damage', multiplier: 1.2, statusEffect: { type: 'burn' as StatusType, chance: 0.3, duration: 2, value: 80 }, targetType: 'enemy', description: 'Fire attack with burn chance' }],
  },
  {
    id: 'enemy_stone_sentry', name: 'Stone Sentry', faction: 'Obsidian Pact', role: 'defensive', rarity: 'common',
    modelId: 'model_enemy_stone_sentry', portraitId: 'portrait_enemy_stone_sentry',
    baseHp: 5000, baseAtk: 500, baseDef: 800, baseSpd: 70, baseAcc: 85, baseRes: 85,
    skills: [{ name: 'Fortify', cooldown: 4, level: 1, type: 'buff', multiplier: 1.0, statusEffect: { type: 'def_up' as StatusType, chance: 1.0, duration: 3, value: 30 }, targetType: 'self', description: 'Raise defenses' }],
  },
  // Chapter 2 — mid tier (rare)
  {
    id: 'enemy_void_stalker', name: 'Void Stalker', faction: 'Veil Walkers', role: 'offensive', rarity: 'rare',
    modelId: 'model_enemy_void_stalker', portraitId: 'portrait_enemy_void_stalker',
    baseHp: 5500, baseAtk: 1400, baseDef: 700, baseSpd: 140, baseAcc: 95, baseRes: 95,
    skills: [
  ...
  {
    id: 'enemy_thunder_brute', name: 'Thunder Brute', faction: 'Stormborn', role: 'offensive', rarity: 'rare',
    modelId: 'model_enemy_thunder_brute', portraitId: 'portrait_enemy_thunder_brute',
    baseHp: 7000, baseAtk: 1200, baseDef: 900, baseSpd: 110, baseAcc: 95, baseRes: 95,
    skills: [
  ...
  {
    id: 'enemy_crystal_shaman', name: 'Crystal Shaman', faction: 'Dawn Sentinels', role: 'support', rarity: 'rare',
    modelId: 'model_enemy_crystal_shaman', portraitId: 'portrait_enemy_crystal_shaman',
    baseHp: 6000, baseAtk: 1000, baseDef: 800, baseSpd: 125, baseAcc: 95, baseRes: 95,
    skills: [
  ...
  // Chapter 3 — high tier (epic)
  {
    id: 'enemy_abyss_knight', name: 'Abyss Knight', faction: 'Obsidian Pact', role: 'offensive', rarity: 'epic',
    modelId: 'model_enemy_abyss_knight', portraitId: 'portrait_enemy_abyss_knight',
    baseHp: 10000, baseAtk: 2200, baseDef: 1400, baseSpd: 130, baseAcc: 105, baseRes: 105,
    skills: [
  ...
  {
    id: 'enemy_lich_warden', name: 'Lich Warden', faction: 'Veil Walkers', role: 'support', rarity: 'epic',
    modelId: 'model_enemy_lich_warden', portraitId: 'portrait_enemy_lich_warden',
    baseHp: 8500, baseAtk: 1600, baseDef: 1200, baseSpd: 135, baseAcc: 105, baseRes: 105,
    skills: [
  ...
  {
    id: 'enemy_storm_colossus', name: 'Storm Colossus', faction: 'Stormborn', role: 'defensive', rarity: 'epic',
    modelId: 'model_enemy_storm_colossus', portraitId: 'portrait_enemy_storm_colossus',
    baseHp: 16000, baseAtk: 1400, baseDef: 2200, baseSpd: 90, baseAcc: 105, baseRes: 105,
    skills: [
...
const dungeonEnemies: EnemyTemplate[] = [
  {
    id: 'enemy_cavern_golem', name: 'Cavern Golem', faction: 'Obsidian Pact', role: 'defensive', rarity: 'rare',
    modelId: 'model_enemy_cavern_golem', portraitId: 'portrait_enemy_cavern_golem',
    baseHp: 8000, baseAtk: 900, baseDef: 1200, baseSpd: 80, baseAcc: 95, baseRes: 95,
    skills: [{ name: 'Rock Crush', cooldown: 3, level: 1, type: 'damage', multiplier: 1.4, targetType: 'enemy', description: 'Heavy rock attack' }],
  },
  {
    id: 'enemy_shard_wraith', name: 'Shard Wraith', faction: 'Veil Walkers', role: 'offensive', rarity: 'rare',
    modelId: 'model_enemy_shard_wraith', portraitId: 'portrait_enemy_shard_wraith',
    baseHp: 4500, baseAtk: 1500, baseDef: 600, baseSpd: 150, baseAcc: 95, baseRes: 95,
    skills: [
  ...
  {
    id: 'enemy_void_herald', name: 'Void Herald', faction: 'Veil Walkers', role: 'offensive', rarity: 'epic',
    modelId: 'model_enemy_void_herald', portraitId: 'portrait_enemy_void_herald',
    baseHp: 12000, baseAtk: 2000, baseDef: 1100, baseSpd: 145, baseAcc: 105, baseRes: 105,
    skills: [
...
const arenaTemplates: EnemyTemplate[] = [
  {
    id: 'arena_berserker', name: 'Arena Berserker', faction: 'Stormborn', role: 'offensive', rarity: 'epic',
    modelId: 'model_arena_berserker', portraitId: 'portrait_arena_berserker',
    baseHp: 8000, baseAtk: 2000, baseDef: 1000, baseSpd: 140, baseAcc: 105, baseRes: 105,
    skills: [
  ...
  {
    id: 'arena_sentinel', name: 'Arena Sentinel', faction: 'Dawn Sentinels', role: 'defensive', rarity: 'epic',
    modelId: 'model_arena_sentinel', portraitId: 'portrait_arena_sentinel',
    baseHp: 14000, baseAtk: 1200, baseDef: 2000, baseSpd: 105, baseAcc: 105, baseRes: 105,
    skills: [
  ...
  {
    id: 'arena_oracle', name: 'Arena Oracle', faction: 'Dawn Sentinels', role: 'support', rarity: 'epic',
    modelId: 'model_arena_oracle', portraitId: 'portrait_arena_oracle',
    baseHp: 9000, baseAtk: 1400, baseDef: 1200, baseSpd: 130, baseAcc: 105, baseRes: 105,
    skills: [
  ...
  {
    id: 'arena_assassin', name: 'Arena Assassin', faction: 'Veil Walkers', role: 'offensive', rarity: 'epic',
    modelId: 'model_arena_assassin', portraitId: 'portrait_arena_assassin',
    baseHp: 6500, baseAtk: 2400, baseDef: 800, baseSpd: 170, baseAcc: 105, baseRes: 105,
    skills: [
  ...
  {
    id: 'arena_warlord', name: 'Arena Warlord', faction: 'Obsidian Pact', role: 'offensive', rarity: 'epic',
    modelId: 'model_arena_warlord', portraitId: 'portrait_arena_warlord',
    baseHp: 11000, baseAtk: 1800, baseDef: 1500, baseSpd: 120, baseAcc: 105, baseRes: 105,
    skills: [
...
/** Scale an enemy template to a target power level — applies role modifiers & per-rarity crit per doc */
function scaleTemplate(template: EnemyTemplate, targetPower: number): BattleUnit {
  ...
  const modded = applyRoleModifiers(template.role, {
    ...
    acc: Math.round(template.baseAcc * (0.9 + scale * 0.1)),
    res: Math.round(template.baseRes * (0.9 + scale * 0.1)),
  })

  // Per-rarity crit per doc §1
  const crit = getCritForRarity(template.rarity)
